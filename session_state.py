...
def reset_session_state_for_new_file() -> None:
    ...
    keys_to_preserve: Set[str] = {
        "session_id", 
        "umls_lookup_term",  # Text input widget for UMLS lookup
        "question_input_widget",  # Text area for questions
        "disease_select_widget",  # Disease selection dropdown
        "file_uploader_widget"    # File uploader widget
    }
