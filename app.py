...
supports interactive ROI selection with a drawable canvas, and provides comprehensive
diagnostic outputs. The system leverages state-of-the-art imaging protocols and robust logging,
ensuring expert-level performance and clarity.
"""
...
# ------------------------------------------------------------------------------
# Monkey-Patch (Optional): Ensure st.elements.image.image_to_url exists
# ------------------------------------------------------------------------------
...
with st.expander("Usage Guide", expanded=False):
    st.info("This tool is for research purposes only. Verify all AI-generated outputs with a certified specialist.")
    st.markdown("**Quick Steps:** 1. Upload image 2. Adjust DICOM window/level (if applicable) 3. Run Analysis 4. Interact (Q&A & Condition Analysis) 5. Generate Report")
st.markdown("---")
