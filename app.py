...
Processes both DICOM and standard images, supports AI-based analysis (initial, Q&A, 
disease-specific, confidence), and allows ROI selection via a drawable canvas.
This version ensures a direct image preview is shown before the canvas.
"""
...
try:
    ...
    logger.warning("pylibjpeg not found. For extended DICOM compatibility, please install pylibjpeg & pylibjpeg-libjpeg.")
...
with st.sidebar:
    ...
    uploaded_file = st.file_uploader(
        ...
        help="Select a standard image or DICOM file."
    )
